...
class DeleteBucketReallocateFundsTestCase(TestCase):
    def setUp(self):
        ...
        responseTwo = self.client.post(
            "/dashboard/transaction/1/", follow=True, data={"amount": "5000", "transactionDate": "01/01/2021", "description": "baseline emergency fund", "transaction_type": "addition"}
        )
        responseTwo = self.client.post(
            "/dashboard/transaction/2/", follow=True, data={"amount": "1000", "transactionDate": "02/03/2021", "description": "baseline slush", "transaction_type": "addition"}
        )
        responseTwo = self.client.post(
            "/dashboard/transaction/3/", follow=True, data={"amount": "30000", "transactionDate": "03/04/2021", "description": "baseline wedding", "transaction_type": "addition"}
        )
        responseTwo = self.client.post(
            "/dashboard/transaction/4/", follow=True, data={"amount": "400", "transactionDate": "04/21/2021", "description": "baseline fun money", "transaction_type": "addition"}
        )
        responseTwo = self.client.post(
            "/dashboard/transaction/3/", follow=True, data={"amount": "26000", "transactionDate": "05/15/2021", "description": "wedding expense", "transaction_type": "subtraction"}
        )
