"""
Django settings for bucketfinance project. Includes some improvements
...
SECRET_KEY = 'n$6@2svtf($g*66(c!w!#t9j7gp5+f8+yzr%4hhseq!%nj5iot'
...
ROOT_URLCONF = 'bucketfinance.urls'
